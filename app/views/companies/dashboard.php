    ...
    <div class="card border-0 shadow-sm" style="border-radius:16px;overflow:hidden;">
      ...
      <div class="card-body p-0">
        ...
        <div class="text-center py-5">
          <i class="bi bi-check-circle-fill text-success" style="font-size:2.5rem;opacity:.6;"></i>
          <p class="text-muted small mt-2 mb-0 fw-500">All caught up! No pending reviews.</p>
        </div>
        <?php else: ?>
