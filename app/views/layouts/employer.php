...
<aside class="sidebar d-none d-lg-flex flex-column">
    <div class="sidebar-logo">
        <a href="<?= url('/') ?>" class="d-flex align-items-center"><img src="/public/assets/img/tatu_logo.png" alt="TaTU Logo" style="height:42px;width:auto;object-fit:contain;"></a>
    </div>
    <?php
    ...
    <nav class="sidebar-nav flex-grow-1">
        ...
        <ul class="list-unstyled mb-0">
            ...
            <?= el(url('/employer/reviews'),      'star',          'Ratings & Reviews', $uri) ?>
